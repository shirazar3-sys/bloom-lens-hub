...
const HeroSection = () => {
  ...
  return <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-20">
...
Share memories
        ...
        duration: 0.8
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-3 md:gap-4">
            {[photo1, photo2, photo3, photo4, photo5, photo6].map((photo, i) => <motion.div key={i} initial={{
            opacity: 0,
            scale: 0.9
          }} animate={{
            opacity: 1,
            ...
            duration: 0.5
                ...
                <div className="aspect-[3/4]">
                  <img src={photo} alt={`Wedding photography ${i + 1}`} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
